...
export const PLAYBOOKS = [
  {
    ...
    design_rules: [
      ...
      "Initialize Mermaid to match the page theme and re-render when the theme changes: pick the Mermaid theme from the effective page appearance (light or dark) at render time, and use the theme-aware `george-showroom design` Mermaid snippet rather than hardcoding a single theme, since Mermaid does not restyle an already-rendered SVG when the viewer toggles the page theme.",
    ],
    pitfalls: [
    ...
    lavish_notes: [
      "A George Showroom diagram should invite precise annotation: make modules, edges, and captions easy to click and discuss.",
  ...
  },
  {
    ...
    lavish_notes: [
      "A George Showroom table should make individual rows easy annotation targets.",
  ...
  },
  {
    ...
    lavish_notes: [
      "A George Showroom comparison should let the user annotate the exact option or tradeoff they want changed.",
  ...
  },
  {
    ...
    lavish_notes: [
      "A George Showroom plan should make a plan and its uncertainties easy to annotate before code exists.",
    ],
  },
  {
    id: "code",
    use_when:
      "Render source code, code files, patches, PR diffs, and before/after code inside George Showroom artifacts",
    choose: [
...
\`\`\``,
    ...
    lavish_notes: [
      "A George Showroom code artifact should make each file, hunk, and relevant line easy to annotate precisely.",
  ...
  },
  {
    ...
    design_rules: [
      ...
      "Put data-lavish-action only on custom (non-native) elements that should act like a feedback control - typically a styled div or span you made clickable - so George Showroom does not annotate it and shows a pointer cursor instead.",
    ...
    lavish_notes: [
      "George Showroom is strongest when the artifact becomes a focused review surface and not just a static page.",
  ...
  },
  {
    ...
    lavish_notes: [
      "A George Showroom slide deck can still collect feedback, but each prompt should refer to a slide or decision.",
